<section class="panel-display panel-threecol_40_25_35 clearfix" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  <?php if ($content['background']): ?>
    <section class="panel-panel panel-col-first panel-col-background clearfix">
        <?php print $content['background']; ?>
    </section>
  <?php endif ?>
  <?php if ($content['top']): ?>
  ...
  <?php if ($content['main_content_col_1'] || $content['main_content_col_2'] || $content['main_content_col_3'] ): ?>
    <section class="panel-panel-wrapper panel-col-main-content-col-wrapper clearfix">
      
    <?php if ($content['main_content_col_1'] || $content['main_content_col_2'] ): ?>
      <section class="panel-panel-wrapper panel-col-main-content-2-col-wrapper">
    ...
    <?php if ($content['main_content_col_3']): ?>
      <section class="panel-panel panel-col-main-content-col-3 panel-col-last clearfix">
